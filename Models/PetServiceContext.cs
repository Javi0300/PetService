...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=PetService.mssql.somee.com;Database=PetService;User ID=A204_SQLLogin_1;Password=j5yyu4x8up");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Perro>(entity =>
            {
                ...
                entity.Property(e => e.IdPerro).ValueGeneratedOnAdd();
                ...
                entity.HasOne(d => d.IdPerroNavigation)
                    .WithOne(p => p.Perro)
                    .HasForeignKey<Perro>(d => d.IdPerro)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<Propietario>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPropietarioNavigation)
                    ...
                    .HasForeignKey<Propietario>(d => d.IdPropietario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<VentaDetalle>(entity =>
            {
                ...
                entity.Property(e => e.IdVentaDetalle).ValueGeneratedOnAdd();
                ...
                entity.HasOne(d => d.IdVentaDetalleNavigation)
                    .WithOne(p => p.VentaDetalle)
                    .HasForeignKey<VentaDetalle>(d => d.IdVentaDetalle)
                    .OnDelete(DeleteBehavior.ClientSetNull)
